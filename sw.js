...
const CACHE = "wcfans-v44";   // v44: v2.38 · fix matches/chat blanking on resume-from-background (keep last-good on a transient fetch blip + retry); refresh R32 on resume
