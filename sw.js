...
const CACHE = "wcfans-v43";   // v43: v2.37 · Egypt-win celebration LIVE (win/Iran-draw/Iran-qualifying-loss; manual override; once-per-dismiss; Celebrate Egypt bar; deploy cutoff excludes the pre-deploy NZ win)
